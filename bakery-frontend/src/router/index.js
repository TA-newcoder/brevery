...
const routes = [
  // ===== PUBLIC / USER PAGES =====
  {
    ...
    children: [
      ...
      { path: 'profile', name: 'profile', component: () => import('@/pages/Profile.vue'), meta: { title: 'Trang cá nhân', requiresAuth: true } },
      { path: 'contact', name: 'contact', component: () => import('@/pages/Contact.vue'), meta: { title: 'Liên hệ' } },
    ],
  },
  // ===== AUTH PAGES =====
  {
  ...
  // ===== ADMIN PAGES =====
  {
    ...
    children: [
      ...
      { path: 'categories', name: 'admin-categories', component: () => import('@/pages/admin/CategoryList.vue'), meta: { title: 'Quản lý Danh mục' } },
